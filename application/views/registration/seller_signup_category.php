    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                    <?php echo form_open("Registration/seller-signup", array('name' => 'signup_category_form', 'id' => 'signup_category_form', 'method' => 'post', 'onsubmit' => 'return settingsController.categoryValidation()')); 
