...
<div class="container-fluid">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 ">
                ...
                <div class="form-inline pull-right ">
                    <?php
                    echo form_open(base_url() . 'dashboard/', array('id' => 'search_quote_form', 'method' => 'get'));
        ...
        <div class="row">
            <div class="col-md-12 ">
                <?php echo $verify_msg ?>
                <?php echo !empty($success_msg) ? $success_msg : ''; ?>
               
                <?php if (!empty($consumer_dashboard_list)) { ?>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <?php
                            foreach ($consumer_dashboard_list as $key => $list) {
                                ?>
                                <tr>
                                    ...
                                    <td> 
                                        ...
                                        <!--<b class="<?php echo $time_class; ?>"> 
                                            <script>document.write(moment('<?php echo date("Y-m-d H:i", $list->sla_milestone); ?>').endOf('minutes').fromNow())
                                            </script>
                                        </b>--> <br/>
                ...
                <?php } else if (!empty($supplier_dashboard_list)) { ?>
                    <table class="table table-striped">
                        <thead >
                            <tr>
                                <th>Order ID</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($supplier_dashboard_list as $k => $item) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <script>
                                           timerCounter("<?php echo $item->job_id;?>","<?php echo date('Y/m/d H:i:s', $item->sla_milestone); ?>");
                                            ...
                                            <!--<b class="<?php echo $time_class; ?>"> 
                                            <script>document.write(moment('<?php echo date("Y-m-d H:i", $item->sla_milestone); ?>').endOf('minutes').fromNow())
                                            </script>
                                        </b>--> <br/>
                ...
                <?php } else if (!empty($freight_dashboard_list)) { ?>
                    <table class="table table-striped">
                        <thead >
                            <tr>
                                <th>Order ID</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($freight_dashboard_list as $k => $data) { ?>
                                <tr>
                                    <td><?php echo "#" . $data->job_id; ?></td>
                                    <td><?php echo $data->job_name; ?></td>
                                    <td><?php echo $data->product_quantity; ?></td>
                                    <td class="text-info"><?php echo $data->job_status_name; ?></td>
                                    <td><?php echo date("F j, Y", $data->created_time); ?></td>
                                    <td>
                                        <?php $time_class = (time() < $data->product_lead_time) ? "text-success" : "text-danger" ?>
                                        <b class="<?php echo $time_class; ?>"> 
                                            <script>
                                                document.write(moment('<?php echo date("Y-m-d H:i", $data->product_lead_time); ?>').endOf('minutes').fromNow())
                                            </script>
                                        </b>
                                        <br/>
                                        <?php echo date("F j, Y", $data->product_lead_time); ?>
                                    </td>
                                    <td>
                                        <?php $time_class = (time() < $data->sla_milestone) ? "text-success" : "text-danger" ?>
                                        <b class="<?php echo $time_class; ?>">  
                                            <script>document.write(moment('<?php echo date("Y-m-d H:i", $data->sla_milestone); ?>').endOf('minutes').fromNow())
                                            </script>
                                        </b> <br/>
                                        <?php echo date("F j, Y", $data->sla_milestone); ?>
                                    </td>

                                    <td><a class="btn btn-blue" href="<?php echo base_url() . "dashboard/job/" . $data->job_id; ?>">View </a></td>
                                </tr>
                            <?php } ?>
                ...
                <?php } else if (!empty($admin_dashboard_list)) { ?>
                    <table class="table table-striped">
                        <thead >
                            <tr>
                                <th>Order ID</th>
