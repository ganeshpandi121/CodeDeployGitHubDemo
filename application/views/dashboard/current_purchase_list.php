    ...
    <div class="container">
        <div class="row">
            <ul class="nav nav-tabs">
                <li><a href="<?php echo base_url('dashboard/current-sales');?>">Current Sale</a></li>
                <li class="active"> <a  href="#current-purchase">Current Purchase</a></li>
                
            </ul>
            <div class="tab-content">
                <div id="current-purchase" class="tab-pane fade in active">
                    <div class="row">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <div class="form-inline pull-right">
                                <?php
                                echo form_open(base_url() . 'dashboard/current-purchases', array('id' => 'search_order_form', 'method' => 'get'));
                    ...
                    <div class="row">
                        ...
                        <?php }else{?>
                            <?php if (!empty($current_purchase_list)) { ?>
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($current_purchase_list as $key => $list) {
                                        ?>
                                        <tr>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="alert alert-info">
                                    <strong>Info!</strong> You don't have any current purchase.
                                </div>
                            <?php }?>
                        <?php }?>
                    </div>        
